                        ...
                        for ($i = 0; $i < $numRows; $i++) {
                            ...
                            print "
                                <tr>
                                    ...
                                    <td >$strength</td>
                                    <td >$weight</td>
                                    <td class='edit'><a href='edit.php?edit=$word&id=$id&t=$dbTable'>edit</a> | <a href='list_telugu_words.php?action=delete&target_id=$id'>delete</a></td>
                                </tr>";
                        }
                    }
